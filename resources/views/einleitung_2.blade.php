          ...
          <div class="container">
            <div class="wrap">
                <div class="fix-8-12 center">
                    <h1>Ihr Resultat</h1>
                    @if ($puzzle1Solved)
                        <p class="small">Sie haben das erste Spiel korrekt gelöst!</p>
                    @else
                        <p class="small">Sie haben das erste Spiel nicht gelöst.</p>
                    @endif

                    @if ($puzzle2Solved)
                        <p class="small">Sie haben das zweite Spiel korrekt gelöst!</p>
                    @else
                        <p class="small">Sie haben das zweite Spiel nicht gelöst.</p>
                    @endif

                    @if ($puzzle3Solved)
                        <p class="small">Sie haben das dritte Spiel korrekt gelöst!</p>
                    @else
                        <p class="small">Sie haben das dritte Spiel nicht gelöst.</p>
                    @endif
                    <br>
                    <a href="{{ route('einleitung_3')}}" class="button" style="border-radius: 7px; color: white; background-color: green;">Weiter</a>
