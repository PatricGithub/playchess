          ...
          <div class="container">
            <div class="wrap">
                <div class="fix-8-12 left magazine2">
                    ...
                    <br>
                    <a href="{{ route('chess_experiment2', ['nextimg' => $nextimg]) }}" class="button" style="border-radius: 7px; color: white; background-color: green;">Weiter</a>
                </div> 
            </div>
            </div>
            </div>
